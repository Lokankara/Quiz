# AWS Certification / Cloud Concepts Set 7

---

## 1. Which AWS service provides a fully managed, serverless workflow orchestration service that makes it easy to sequence AWS services and orchestrate complex business processes?
...
## 2. A company wants to implement a managed service for analyzing and visualizing data from multiple sources to create interactive dashboards. Which AWS service should they use?
...
## 3. Which AWS service provides a managed, highly available, and scalable message publishing and subscription service?
...
- To securely transfer data between on-premises and AWS
- To migrate databases to AWS
- To sync data between S3 buckets
...
## 5. Which AWS service provides a managed service for creating and managing serverless APIs with automatic scaling and built-in security?
...
## 6. A company needs to implement a managed service for discovering, classifying, and protecting sensitive data across their AWS environment. Which AWS service should they use?
...
## 7. Which AWS service provides a managed service for implementing real-time communication applications with audio, video, and data transmission?
...
## 8. What is the main purpose of AWS Backup?

- To centralize and automate backup of AWS resources
...
## 9. Which AWS service provides a managed service for implementing secure, scalable, and highly available time-series databases?
...
## 10. A company wants to implement a managed service for building and deploying containerized applications without managing servers or clusters. Which AWS service should they use?
...
## 11. Which AWS service provides a managed service for implementing real-time data analytics on streaming data using SQL?
...
## 12. What is the primary purpose of AWS Cloud9?
...
## 13. Which AWS service provides a managed service for implementing real-time video streaming and processing with low latency?
...
## 14. A company needs to implement a managed service for analyzing customer behavior and creating personalized recommendations. Which AWS service should they use?
...
## 15. Which AWS service provides a managed service for implementing secure and scalable graph databases for highly connected datasets?
...
## 16. What is the main purpose of AWS CodeStar?

- To provide a unified interface for developing, building, and deploying applications
- To monitor AWS resources
...
## 17. Which AWS service provides a managed service for implementing real-time messaging and push notifications for mobile applications with advanced targeting capabilities?
...
## 18. A company wants to implement a managed service for creating and managing highly available and scalable document databases with MongoDB compatibility. Which AWS service should they use?
...
## 19. Which AWS service provides a managed service for implementing serverless APIs with GraphQL and real-time subscriptions?
...
## 20. What is the primary purpose of AWS Systems Manager Session Manager?

- To provide secure and auditable access to EC2 instances without requiring SSH keys or opening inbound ports
- To monitor AWS resources
...
## 21. Which AWS service provides a managed service for implementing real-time monitoring and observability of distributed applications?
...
## 22. A company needs to implement a managed service for real-time data ingestion and processing at scale with support for multiple data formats. Which AWS service should they use?
...
## 23. Which AWS service provides a managed service for implementing real-time communication and messaging between different components of an application with fan-out capabilities?
...
## 24. What is the main purpose of AWS Cost Explorer?

- To visualize, understand, and manage AWS costs and usage over time
- To monitor AWS resources
- To manage user access
- To encrypt data in transit
...
## 25. Which AWS service provides a managed service for implementing real-time data processing and analytics with Apache Spark and Apache Hadoop?
...
## 26. A company wants to implement a managed service for creating and managing highly available, scalable, and secure APIs with built-in throttling and caching. Which AWS service should they use?
...
## 27. Which AWS service provides a managed service for implementing secure and scalable NoSQL databases with automatic scaling and multi-region replication?
...
## 28. What is the primary purpose of AWS Systems Manager Parameter Store?
...
## 29. Which AWS service provides a managed service for implementing real-time video streaming and processing with advanced features like live-to-VOD conversion?
...
## 30. A company needs to implement a managed service for analyzing and processing large datasets using serverless Apache Spark without managing clusters. Which AWS service should they use?
...
## 31. Which AWS service provides a managed service for implementing secure, scalable, and highly available in-memory caching for web applications?
...
## 32. What is the main purpose of AWS CloudFormation StackSets?

- To deploy stacks across multiple accounts and regions
- To monitor CloudFormation stacks
- To manage user access to stacks
...
## 33. Which AWS service provides a managed service for implementing real-time communication applications with voice, video, and messaging capabilities?
...
## 34. A company wants to implement a managed service for creating and managing serverless applications using containers with automatic scaling. Which AWS service should they use?
...
## 35. Which AWS service provides a managed service for implementing real-time data analytics on streaming data using Apache Flink?
...
## 36. What is the primary purpose of AWS Secrets Manager?
...
## 37. Which AWS service provides a managed service for implementing real-time data streaming and processing for IoT applications?
...
## 38. A company needs to implement a managed service for creating and managing highly available and scalable time-series data analytics with built-in machine learning capabilities. Which AWS service should they use?
...
## 39. Which AWS service provides a managed service for implementing secure and scalable document database with MongoDB compatibility and automatic scaling?
...
## 40. What is the main purpose of AWS Systems Manager Run Command?

- To execute commands on managed instances at scale
- To monitor AWS resources
- To manage user access policies
- To log API calls
...
## 41. Which AWS service provides a managed service for implementing real-time messaging and push notifications for mobile and web applications with advanced analytics?
...
## 42. A company wants to implement a managed service for creating and managing highly available and scalable graph databases with built-in machine learning capabilities. Which AWS service should they use?
...
## 43. Which AWS service provides a managed service for implementing real-time data analytics on streaming data with support for complex event processing?
...
## 44. What is the primary purpose of AWS Systems Manager Automation?
...
## 45. Which AWS service provides a managed service for implementing real-time video streaming and processing with advanced content protection features?
...
## 46. A company needs to implement a managed service for analyzing customer behavior and creating personalized recommendations with real-time updates. Which AWS service should they use?
...
## 47. Which AWS service provides a managed service for implementing secure, scalable, and highly available caching with support for multiple caching engines?
...
## 48. What is the main purpose of AWS Systems Manager Patch Manager?

- To automate patching of managed instances
- To monitor AWS resources
- To manage user access policies
- To log API calls
...
## 49. Which AWS service provides a managed service for implementing real-time communication and messaging between different components of an application with message filtering capabilities?
...
## 50. A company wants to implement a managed service for creating and managing highly available, scalable, and secure APIs with built-in authentication and authorization features. Which AWS service should they use?
...
## 51. Which AWS service provides a managed service for implementing real-time data ingestion and processing with support for multiple data sources and formats?
...
## 52. What is the primary purpose of AWS Systems Manager Inventory?

- To collect and query configuration and inventory information about managed instances
- To monitor AWS resources
- To manage user access policies
- To log API calls
...
## 53. Which AWS service provides a managed service for implementing real-time video streaming and processing with advanced machine learning capabilities for content analysis?
...
## 54. A company needs to implement a managed service for analyzing and processing large datasets using serverless Apache Spark with automatic scaling. Which AWS service should they use?
...
## 55. Which AWS service provides a managed service for implementing secure and scalable NoSQL databases with automatic scaling and global replication?
...
## 56. What is the main purpose of AWS Systems Manager Distributor?

- To securely store and distribute software packages to managed instances
- To monitor AWS resources
- To manage user access policies
- To log API calls
...
## 57. Which AWS service provides a managed service for implementing real-time data analytics on streaming data with support for custom business logic?
...
## 58. A company wants to implement a managed service for creating and managing serverless APIs with GraphQL and real-time subscriptions with automatic scaling. Which AWS service should they use?
...
## 59. Which AWS service provides a managed service for implementing real-time communication applications with audio, video, and data transmission with built-in analytics?
...
## 60. What is the primary purpose of AWS Systems Manager Maintenance Windows?

- To define time windows for performing maintenance on managed instances
- To monitor AWS resources
- To manage user access policies
- To log API calls
...
## 61. Which AWS service provides a managed service for implementing real-time messaging and push notifications for mobile applications with advanced segmentation and personalization?
...
## 62. A company needs to implement a managed service for creating and managing highly available and scalable graph databases with built-in backup and recovery capabilities. Which AWS service should they use?
...
## 63. Which AWS service provides a managed service for implementing real-time data analytics on streaming data with support for windowing functions?
...
## 64. What is the main purpose of AWS Systems Manager State Manager?

- To maintain consistent configurations across managed instances
- To monitor AWS resources
- To manage user access policies
- To log API calls
...
## 65. Which AWS service provides a managed service for implementing real-time video streaming and processing with support for multiple quality levels and adaptive bitrate streaming?
